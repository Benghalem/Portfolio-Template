                ...
                <div className="qualification__sections">
                    ...
                    : "qualification__content"
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Wep Designer</h3>
                                <span className="qualification__subtitle">Algria - Institute</span>
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Wep Development</h3>
                                <span className="qualification__subtitle">Algria - Institute</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                     2018 - 2020
                    ...
                    : "qualification__content"
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Ibn Khaldon - Algria</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                     2020 - 2021
                                </div>
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Wep Designer</h3>
                                <span className="qualification__subtitle">Ibn kha - Algria</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calendar-alt"></i>
                                     2018 - 2020
                                </div>
